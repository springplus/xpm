 ...
 * @param config
 */
function mainCtrlTmpl($scope, moduleData, $$stateProxy, config) {
...
function mainFindActiveDetailView(config, containerName) {
    try {
        if (!containerName) {
            console.error("未配置containerName：" + containerName + ",请检查controller中是否有传该参数，如mainDetailCtrlTmpl($scope, moduleData, $stateParams, config, \"tabs\")。")
            return undefined;
        }
...
function mainStepsDetailCtrlTmpl($scope, moduleData, $stateParams, config) {
    return _mainDetailCtrlTmpl($scope, moduleData, $stateParams, config, "steps");
}
function mainTabsDetailCtrlTmpl($scope, moduleData, $stateParams, config) {
    return _mainDetailCtrlTmpl($scope, moduleData, $stateParams, config, "tabs");
}
function mainNoneDetailCtrlTmpl($scope, moduleData, $stateParams, config) {
    return _mainDetailCtrlTmpl($scope, moduleData, $stateParams, config, "none");
}
function _mainDetailCtrlTmpl($scope, moduleData, $stateParams, config, containerName) {
    var __moduleName = config.moduleName;
    var __resName = config.resName;
    $scope.refresh = function () {
